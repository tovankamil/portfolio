...
const index = () => {
  return (
    <div className="relative">
      <div className="max-w-[1264px]  mx-auto mt-[150px] z-10 bg">
        <Label text="Experience" />

        {/* Detail Experience */}
        <div className="w-full flex flex-row  justify-between items-start mt-[100px]">
        ...
        <div className="flex flex-row justify-start items-start mt-14 z-30">
          {/* Key features  */}
